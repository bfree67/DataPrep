...
Monthcos = onehotencode(Xt,23) #months

fftlength = 6
#FAHO3W = fft(Xt,20, fftlength)
#JARO3W = fft(Xt,21, fftlength)
#MANO3W = fft(Xt,22, fftlength)

Xtr = np.concatenate((Hcos, Hsin, Month, FAHWDcos, FAHWDsin, JARWDcos, JARWDsin, 
...
#Xtr = np.concatenate((FAHO3, JARO3), axis =1)
...
Xtr = timedelay(Xtr,11,1)  ### shift input out for TDNN
